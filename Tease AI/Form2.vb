...
#Region "-------------------------------------- Scripts -------------------------------------------------"
	...
	Public Shared Sub saveCheckedListBox(ByVal target As CheckedListBox, ByVal filePath As String)
		Try
	...
	Private Sub loadCheckedListBox(ByVal target As CheckedListBox,
			  ByVal loadPath As String,
			  ByVal scriptDir As String,
					Optional ByVal preEnable As Boolean = True)
		Try
...
SkipDeserializing:
	...
	Private Sub CLBStartList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CLBStartList.SelectedIndexChanged, CLBModuleList.SelectedIndexChanged, CLBLinkList.SelectedIndexChanged, CLBEndList.SelectedIndexChanged
		Try
	...
	Private Sub BtnScriptsOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNScriptOpen.Click
	...
	Private Sub BtnScriptsSelectAutomated_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNScriptAvailable.Click, BTNScriptNone.Click, BTNScriptAll.Click
...
#Region "----------------------------------------- Glitter ----------------------------------------------"
	...
	Private Sub GlitterAV_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GlitterAV.Click
		...
		End If
	End Sub
	Private Sub GlitterAV1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GlitterAV1.Click
		If OpenFileDialog1.ShowDialog() = DialogResult.OK Then
			Try
		...
		End If
	End Sub
	Private Sub GlitterAV2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GlitterAV2.Click
		If OpenFileDialog1.ShowDialog() = DialogResult.OK Then
			Try
		...
		End If
	End Sub
	Private Sub GlitterAV3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GlitterAV3.Click
		If OpenFileDialog1.ShowDialog() = DialogResult.OK Then
			Try
	...
	Private Sub Button35_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGlitterD.Click
		...
		End If
	End Sub
	Private Sub Button27_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGlitter1.Click
		If GetColor.ShowDialog() = DialogResult.OK Then
			LBLGlitterNC1.ForeColor = GetColor.Color
		End If
	End Sub
	Private Sub Button4_Click_3(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGlitter2.Click
		If GetColor.ShowDialog() = DialogResult.OK Then
			LBLGlitterNC2.ForeColor = GetColor.Color
		End If
	End Sub
	Private Sub Button26_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGlitter3.Click
		If GetColor.ShowDialog() = DialogResult.OK Then
			LBLGlitterNC3.ForeColor = GetColor.Color
		End If
	End Sub

	Private Sub CBGlitterFeed_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBGlitterFeed.Click, CBGlitterFeedScripts.Click, CBGlitterFeedOff.Click
	...
	Private Sub BTNGlitterD_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNGlitterD.MouseHover
	...
	End Sub
	Private Sub GlitterAV_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles GlitterAV.MouseHover
		TTDir.SetToolTip(GlitterAV, "Click here to set the image the domme will use as her Glitter avatar.")
	End Sub
	Private Sub LBLGlitterNCDomme_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLGlitterNCDomme.MouseHover, LBLGlitterNC1.MouseHover, LBLGlitterNC2.MouseHover, LBLGlitterNC3.MouseHover
	...
	End Sub
	Private Sub TBGlitterShortName_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBGlitterShortName.MouseHover
		TTDir.SetToolTip(TBGlitterShortName, "This is the name that the domme's contacts will refer to her as in the Glitter feed.")
	End Sub
	Private Sub CBTease_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTease.MouseHover
		TTDir.SetToolTip(CBTease, "When this box is checked, the domme will make posts referencing your ongoing teasing and denial.")
	End Sub
	Private Sub CBEgotist_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBEgotist.MouseHover
		TTDir.SetToolTip(CBEgotist, "When this box is checked, the domme will make self-centered posts stating how amazing she is.")
	End Sub
	Private Sub CBTrivia_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTrivia.MouseHover
		TTDir.SetToolTip(CBTrivia, "When this box is checked, the domme will make posts containing quotes or general trivia.")
	End Sub
	Private Sub CBDaily_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBDaily.MouseHover
		TTDir.SetToolTip(CBDaily, "When this box is checked, the domme will make mundane posts about her day.")
	End Sub
	Private Sub CBCustom1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCustom1.MouseHover
	...
	End Sub
	Private Sub CBCustom2_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCustom2.MouseHover
		TTDir.SetToolTip(CBCustom2, "When this box is checked, the domme will make posts taken from Custom 2" & Environment.NewLine &
				"folder in the Glitter scripts directory for her personality style.")
	End Sub
	Private Sub GlitterSlider_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles GlitterSlider.MouseHover
	...
	End Sub
	Private Sub LBLGlitterSlider_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles LBLGlitterSlider.MouseHover
	...
	Private Sub TBGlitter1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBGlitter1.MouseHover, TBGlitter2.MouseHover, TBGlitter3.MouseHover
		TTDir.SetToolTip(sender, "This will be the name of this contact as it appears in the Glitter feed.")
	End Sub
	Private Sub GlitterSlider1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles GlitterSlider1.MouseHover, GlitterSlider2.MouseHover, GlitterSlider3.MouseHover, LBLGlitterSlider1.MouseHover, LBLGlitterSlider2.MouseHover, LBLGlitterSlider3.MouseHover
	...
	End Sub
	Private Sub GlitterAV1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles GlitterAV1.MouseHover, GlitterAV2.MouseHover, GlitterAV3.MouseHover
		TTDir.SetToolTip(sender, "Click here to set the image that this contact will use as her Glitter avatar.")
	End Sub
	Private Sub CBGlitter1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBGlitter1.MouseHover, CBGlitter2.MouseHover, CBGlitter3.MouseHover
		TTDir.SetToolTip(sender, "This check box enables this contact's participation in the Glitter feed.")
	End Sub
	Private Sub BTNGlitter1_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNGlitter1.MouseHover, BTNGlitter2.MouseHover, BTNGlitter3.MouseHover
...
#Region "----------------------------------------- Games ------------------------------------------------"
	...
	Private Sub CardImageSet(ByVal sender As PictureBox, ByVal filepath As String)
		Try
	...
	Private Sub CardPictureboxes_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles _
	...
	Private Sub CardPictureboxes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
	...
	''' </summary>
	Private Sub CardTextboxes_Validating(ByVal sender As Object, ByVal e As CancelEventArgs) Handles _
...
#Region "-------------------------------------- URL Files -----------------------------------------------"
	...
	Private Sub CBWISaveToDisk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBWISaveToDisk.CheckedChanged
	...
	Private Sub BTNWIAddandContinue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWIAddandContinue.Click
		ApproveImage = 1
	End Sub

	Private Sub BTNWIContinue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWIContinue.Click
		ApproveImage = 2
	End Sub

	Private Sub BTNCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWICancel.Click
	...
	Private Sub BtnWiNavigate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWINext.Click, BTNWIPrevious.Click
...
TryNextImage:
	...
	Private Sub BtnWiRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWIRemove.Click
	...
	Private Sub BtnWiDisliked_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWIDisliked.Click
	...
	Private Sub WebPictureBox_MouseWheel(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles WebPictureBox.MouseWheel
	...
	Private Sub LBLWebImageCount_DoubleClick(ByVal sender As Object, ByVal e As EventArgs) Handles LBLWebImageCount.DoubleClick
	...
	Private Sub BtnWiSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWISave.Click
	...
	Private Sub Button38_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWICreateURL.Click,
...
#Region "------------------------------------- Hardcore Images -------------------------------------------"
	...
	Private Sub BTNIHardcore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNIHardcore.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Softcore Images -------------------------------------------"
	...
	Private Sub BTNISoftcore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNISoftcore.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Lesbian Images --------------------------------------------"
	...
	Private Sub BTNILesbian_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNILesbian.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Blowjob Images --------------------------------------------"
	...
	Private Sub BTNIBlowjob_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNIBlowjob.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Femdom Images ---------------------------------------------"
	...
	Private Sub BTNIFemdom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNIFemdom.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Lezdom Images ---------------------------------------------"
	...
	Private Sub BTNILezdom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNILezdom.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Hentai Images ---------------------------------------------"
	...
	Private Sub BTNIHentai_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNIHentai.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Maledom Images ---------------------------------------------"
	...
	Private Sub BTNIMaledom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNIMaledom.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- General Images ---------------------------------------------"
	...
	Private Sub BTNIGeneral_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNIGeneral.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Captions Images ---------------------------------------------"
	...
	Private Sub BTNICaptions_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNICaptions.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Boobs Images ----------------------------------------------"
	...
	Private Sub BTNBoobPath_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBoobPath.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Butts Images ----------------------------------------------"
	...
	Private Sub BTNButtPath_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNButtPath.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#End Region	' Butt
	...
	Private Sub LBLISoftcore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxISoftcore.DoubleClick
		TbxISoftcore.Text = "No path selected"
	End Sub

	Private Sub LBLILesbian_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxILesbian.DoubleClick
		TbxILesbian.Text = "No path selected"
	End Sub

	Private Sub LBLIBlowjob_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxIBlowjob.DoubleClick
		TbxIBlowjob.Text = "No path selected"
	End Sub

	Private Sub LBLIFemdom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxIFemdom.DoubleClick
		TbxIFemdom.Text = "No path selected"
	End Sub

	Private Sub LBLILezdom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxILezdom.DoubleClick
		TbxILezdom.Text = "No path selected"
	End Sub

	Private Sub LBLIHentai_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxIHentai.DoubleClick
		TbxIHentai.Text = "No path selected"
	End Sub

	Private Sub LBLIGay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxIGay.DoubleClick
		TbxIGay.Text = "No path selected"
	End Sub

	Private Sub LBLIMaledom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxIMaledom.DoubleClick
		TbxIMaledom.Text = "No path selected"
	End Sub

	Private Sub LBLICaptions_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxICaptions.DoubleClick
		TbxICaptions.Text = "No path selected"
	End Sub

	Private Sub LBLIGeneral_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TbxIGeneral.DoubleClick
		TbxIGeneral.Text = "No path selected"
	End Sub

	Private Sub LBLIHardcore_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIHardcore.MouseHover
		TTDir.SetToolTip(TbxIHardcore, TbxIHardcore.Text)
	End Sub
	Private Sub LBLISoftcore_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxISoftcore.MouseHover
		TTDir.SetToolTip(TbxISoftcore, TbxISoftcore.Text)
	End Sub
	Private Sub LBLILesbian_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxILesbian.MouseHover
		TTDir.SetToolTip(TbxILesbian, TbxILesbian.Text)
	End Sub
	Private Sub LBLIBlowjob_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIBlowjob.MouseHover
		TTDir.SetToolTip(TbxIBlowjob, TbxIBlowjob.Text)
	End Sub
	Private Sub LBLIFemdom_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIFemdom.MouseHover
		TTDir.SetToolTip(TbxIFemdom, TbxIFemdom.Text)
	End Sub
	Private Sub LBLILezdom_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxILezdom.MouseHover
		TTDir.SetToolTip(TbxILezdom, TbxILezdom.Text)
	End Sub
	Private Sub LBLIHentai_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIHentai.MouseHover
		TTDir.SetToolTip(TbxIHentai, TbxIHentai.Text)
	End Sub
	Private Sub LBLIGay_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIGay.MouseHover
		TTDir.SetToolTip(TbxIGay, TbxIGay.Text)
	End Sub
	Private Sub LBLIMaledom_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIMaledom.MouseHover
		TTDir.SetToolTip(TbxIMaledom, TbxIMaledom.Text)
	End Sub
	Private Sub LBLICaptions_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxICaptions.MouseHover
		TTDir.SetToolTip(TbxICaptions, TbxICaptions.Text)
	End Sub
	Private Sub LBLIGeneral_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIGeneral.MouseHover
		TTDir.SetToolTip(TbxIGeneral, TbxIGeneral.Text)
	End Sub

	Private Sub LBLBoobPath_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIBoobs.MouseHover
		TTDir.SetToolTip(TbxIBoobs, TbxIBoobs.Text)
	End Sub

	Private Sub LBLButtPath_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TbxIButts.MouseHover
		TTDir.SetToolTip(TbxIButts, TbxIButts.Text)
	End Sub

#Region "----------------------------------- GenreImages-Url-Files --------------------------------------"

	Private Sub BtnImageUrlSetFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImageUrlHardcore.Click,
...
#Region "--------------------------------------- Videos -------------------------------------------------"
	...
	Private Sub TxbVideoFolder_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxbVideoHardCore.MouseHover,
...
#Region "------------------------------------- Hardcore Videos -------------------------------------------"
	...
	Private Sub BTNVideoHardCore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoHardCore.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Softcore Videos -------------------------------------------"
	...
	Private Sub BTNVideoSoftCore_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoSoftCore.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Lesbian Videos --------------------------------------------"
	...
	Private Sub BTNVideoLesbian_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoLesbian.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Blowjob Videos --------------------------------------------"
	...
	Private Sub BTNVideoBlowjob_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoBlowjob.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- Femdom -------------------------------------------------"
	...
	Private Sub BTNVideoFemDom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoFemDom.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- Femsub Videos ---------------------------------------------"
	...
	Private Sub BTNVideoFemSub_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoFemSub.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- JOI Videos ------------------------------------------------"
	...
	Private Sub BTNVideoJOI_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoJOI.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- CH Videos -------------------------------------------------"
	...
	Private Sub BTNVideoCH_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoCH.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "------------------------------------- General Videos --------------------------------------------"
	...
	Private Sub BTNVideoGeneral_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoGeneral.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- HardcoreD ----------------------------------------------"
	...
	Private Sub BTNVideoHardcoreD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoHardCoreD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- SoftcoreD ----------------------------------------------"
	...
	Private Sub BTNVideoSoftcoreD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoSoftCoreD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- LesbianD -----------------------------------------------"
	...
	Private Sub BTNVideoLesbianD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoLesbianD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- BlowjobD -----------------------------------------------"
	...
	Private Sub BTNVideoBlowjobD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoBlowjobD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- FemdomD ------------------------------------------------"
	...
	Private Sub BTNVideoFemdomD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoFemDomD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- FemsubD ------------------------------------------------"
	...
	Private Sub BTNVideoFemsubD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoFemSubD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- CH-D ---------------------------------------------------"
	...
	Private Sub BTNVideoCHD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoCHD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#Region "---------------------------------------- GeneralD -----------------------------------------------"
	...
	Private Sub BTNVideoGeneralD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoGeneralD.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
...
#End Region	' Videos
	...
	Private Sub CockSizeNumBox_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CockSizeNumBox.LostFocus
		My.Settings.SubCockSize = CockSizeNumBox.Value
	End Sub


	Private Sub NBCensorShowMin_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorShowMin.Leave
		My.Settings.NBCensorShowMin = NBCensorShowMin.Value
		Debug.Print(My.Settings.NBCensorShowMin & " " & NBCensorShowMin.Value)
	End Sub

	Private Sub NBCensorShowMax_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorShowMax.Leave
		My.Settings.NBCensorShowMax = NBCensorShowMax.Value
	End Sub

	Private Sub NBCensorHideMin_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorHideMin.Leave
		My.Settings.NBCensorHideMin = NBCensorHideMin.Value
	End Sub

	Private Sub NBCensorHideMax_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorHideMax.Leave
		My.Settings.NBCensorHideMax = NBCensorHideMax.Value
	End Sub

	Private Sub CBCensorConstant_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBCensorConstant.CheckedChanged
	...
	Private Sub NBCensorShowMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorShowMin.ValueChanged
		If NBCensorShowMin.Value > NBCensorShowMax.Value Then NBCensorShowMin.Value = NBCensorShowMax.Value
	End Sub

	Private Sub NBCensorShowMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorShowMax.ValueChanged
		If NBCensorShowMax.Value < NBCensorShowMin.Value Then NBCensorShowMax.Value = NBCensorShowMin.Value
	End Sub

	Private Sub NBTeaseLengthMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTeaseLengthMin.LostFocus
		My.Settings.TeaseLengthMin = NBTeaseLengthMin.Value
	End Sub

	Private Sub NBTeaseLengthMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTeaseLengthMax.LostFocus
		My.Settings.TeaseLengthMax = NBTeaseLengthMax.Value
	End Sub

	Private Sub NBTauntCycleMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTauntCycleMin.LostFocus
		My.Settings.TauntCycleMin = NBTauntCycleMin.Value
	End Sub

	Private Sub NBTauntCycleMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTauntCycleMax.LostFocus
		My.Settings.TauntCycleMax = NBTauntCycleMax.Value
	End Sub
	Private Sub NBRedLightMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBRedLightMin.LostFocus
		My.Settings.RedLightMin = NBRedLightMin.Value
	End Sub

	Private Sub NBRedLightMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBRedLightMax.LostFocus
		My.Settings.RedLightMax = NBRedLightMax.Value
	End Sub
	Private Sub NBGreenLightMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBGreenLightMin.LostFocus
		My.Settings.GreenLightMin = NBGreenLightMin.Value
	End Sub

	Private Sub NBGreenLightMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBGreenLightMax.LostFocus
		My.Settings.GreenLightMax = NBGreenLightMax.Value
	End Sub

	Private Sub NBTeaseLengthMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTeaseLengthMin.ValueChanged
		If NBTeaseLengthMin.Value > NBTeaseLengthMax.Value Then NBTeaseLengthMin.Value = NBTeaseLengthMax.Value
	End Sub

	Private Sub NBTeaseLengthMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTeaseLengthMax.ValueChanged
		If NBTeaseLengthMax.Value < NBTeaseLengthMin.Value Then NBTeaseLengthMax.Value = NBTeaseLengthMin.Value
	End Sub

	Private Sub NBTauntCycleMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTauntCycleMin.ValueChanged
		If NBTauntCycleMin.Value > NBTauntCycleMax.Value Then NBTauntCycleMin.Value = NBTauntCycleMax.Value
	End Sub

	Private Sub NBTauntCycleMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTauntCycleMax.ValueChanged
		If NBTauntCycleMax.Value < NBTauntCycleMin.Value Then NBTauntCycleMax.Value = NBTauntCycleMin.Value
	End Sub

	Private Sub NBCensorHideMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorHideMin.ValueChanged
		If NBCensorHideMin.Value > NBCensorHideMax.Value Then NBCensorHideMin.Value = NBCensorHideMax.Value
	End Sub

	Private Sub NBCensorHideMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBCensorHideMax.ValueChanged
	...
	Private Sub Button26_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoModLoad.Click
	...
	Private Sub BTNVideoModClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoModClear.Click
	...
	Private Sub BTNVideoModSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNVideoModSave.Click
	...
	Private Sub CBGlitModType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBGlitModType.SelectedIndexChanged
	...
	Private Sub LBGlitModScripts_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBGlitModScripts.SelectedIndexChanged
	...
	Private Sub SliderSTF_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SliderSTF.Scroll
	...
	Private Sub TauntSlider_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TauntSlider.LostFocus
	...
	Private Sub giveupCheckBox_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles giveupCheckBox.MouseClick
		My.Settings.GiveUpReturn = giveupCheckBox.Checked
		My.Settings.Save()
	End Sub
	Private Sub NBWritingTaskMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBWritingTaskMin.LostFocus
		My.Settings.NBWritingTaskMin = NBWritingTaskMin.Value
	End Sub

	Private Sub NBWritingTaskMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBWritingTaskMin.ValueChanged
		If NBWritingTaskMin.Value > NBWritingTaskMax.Value Then NBWritingTaskMin.Value = NBWritingTaskMax.Value
	End Sub

	Private Sub NBWritingTaskMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBWritingTaskMax.LostFocus
		My.Settings.NBWritingTaskMax = NBWritingTaskMax.Value
	End Sub

	Private Sub NBWritingTaskMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBWritingTaskMax.ValueChanged
		If NBWritingTaskMax.Value < NBWritingTaskMin.Value Then NBWritingTaskMax.Value = NBWritingTaskMin.Value
	End Sub


	Private Sub BTNTagDir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNTagDir.Click
	...
	Private Sub TBTagDir_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TBTagDir.KeyPress
	...
	Private Sub BTNTagSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNTagSave.Click
	...
	Private Sub BTNTagNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNTagNext.Click
	...
	Private Sub BTNTagPrevious_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNTagPrevious.Click
	...
	Private Sub G1Honorific_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles G1Honorific.LostFocus
		My.Settings.G1Honorific = G1Honorific.Text
	End Sub

	Private Sub G2Honorific_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles G2Honorific.LostFocus
		My.Settings.G2Honorific = G2Honorific.Text
	End Sub

	Private Sub G3Honorific_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles G3Honorific.LostFocus
		My.Settings.G3Honorific = G3Honorific.Text
	End Sub

	Private Sub RandomHonorific_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RandomHonorific.LostFocus
		My.Settings.RandomHonorific = RandomHonorific.Text
	End Sub

	Private Sub CBHonorificInclude_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBHonorificInclude.LostFocus
	...
	Private Sub subAgeNumBox_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles subAgeNumBox.LostFocus
		My.Settings.SubAge = subAgeNumBox.Value
	End Sub

	Private Sub NBDomBirthdayMonth_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBDomBirthdayMonth.LostFocus
		My.Settings.DomBirthMonth = NBDomBirthdayMonth.Value
	End Sub

	Private Sub NBDomBirthdayDay_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBDomBirthdayDay.LostFocus
		My.Settings.DomBirthDay = NBDomBirthdayDay.Value
	End Sub


	Private Sub NBBirthdayMonth_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBBirthdayMonth.LostFocus
		My.Settings.SubBirthMonth = NBBirthdayMonth.Value
	End Sub

	Private Sub NBBirthdayDay_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBBirthdayDay.LostFocus
		My.Settings.SubBirthDay = NBBirthdayDay.Value
	End Sub

	Private Sub TBSubHairColor_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBSubHairColor.LostFocus
		My.Settings.SubHair = TBSubHairColor.Text
	End Sub

	Private Sub TBSubEyeColor_LostFocus(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBSubEyeColor.LostFocus
	...
	Private Sub NBBirthdayMonth_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBBirthdayMonth.MouseLeave
	...
	Private Sub NBDomBirthdayMonth_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBDomBirthdayMonth.MouseLeave
	...
	Function InstrCount(ByVal StringToSearch As String,
	...
	Private Sub TBTagDir_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TBTagDir.MouseClick
		TBTagDir.SelectionStart = 0
		TBTagDir.SelectionLength = Len(TBTagDir.Text)
	End Sub

	Private Sub TBWIDirectory_MouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles TBWIDirectory.MouseClick
	...
	Private Sub URLFileList_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles URLFileList.LostFocus
		SaveURLFileSelection()
	End Sub


	Private Sub URLFileList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles URLFileList.SelectedIndexChanged
	...
	Private Sub BTNURLFilesAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNURLFilesAll.Click
		For i As Integer = 0 To URLFileList.Items.Count - 1
			URLFileList.SetItemChecked(i, True)
		Next
		SaveURLFileSelection()
	...
	Private Sub BTNURLFilesNone_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNURLFilesNone.Click
		For i As Integer = 0 To URLFileList.Items.Count - 1
	...
	Private Sub CBCBTCock_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBCBTCock.LostFocus
	...
	Private Sub CBCBTBalls_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBCBTBalls.LostFocus
	...
	Private Sub Button9_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNLocalTagDir.Click
		If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
	...
	Private Sub BTNLocalTagNext_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNLocalTagNext.Click
	...
	Private Sub NBLongEdge_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBLongEdge.LostFocus
		My.Settings.LongEdge = NBLongEdge.Value
	End Sub


	Private Sub NBHoldTheEdgeMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBHoldTheEdgeMax.LostFocus
		My.Settings.HoldTheEdgeMax = NBHoldTheEdgeMax.Value
		My.Settings.HoldTheEdgeMaxAmount = LBLMaxHold.Text
	End Sub

	Private Sub NBHoldTheEdgeMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBHoldTheEdgeMin.LostFocus
		My.Settings.HoldTheEdgeMin = NBHoldTheEdgeMin.Value
		My.Settings.HoldTheEdgeMinAmount = LBLMinHold.Text
	End Sub

	Private Sub NBHoldTheEdgeMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBHoldTheEdgeMax.ValueChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub NBHoldTheEdgeMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBHoldTheEdgeMin.ValueChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub NBLongHoldMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBLongHoldMax.LostFocus
		My.Settings.LongHoldMax = NBLongHoldMax.Value
	End Sub

	Private Sub NBLongHoldMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBLongHoldMin.LostFocus
		My.Settings.LongHoldMin = NBLongHoldMin.Value
	End Sub

	Private Sub NBLongHoldMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBLongHoldMax.ValueChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub NBLongHoldMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBLongHoldMin.ValueChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub NBExtremeHoldMax_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBExtremeHoldMax.LostFocus
		My.Settings.ExtremeHoldMax = NBExtremeHoldMax.Value
	End Sub

	Private Sub NBExtremeHoldMin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBExtremeHoldMin.LostFocus
		My.Settings.ExtremeHoldMin = NBExtremeHoldMin.Value
	End Sub

	Private Sub NBExtremeHoldMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBExtremeHoldMax.ValueChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub NBExtremeHoldMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBExtremeHoldMin.ValueChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub CBTSlider_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBTSlider.Scroll
		If FrmSettingsLoading = False Then
	...
	Private Sub CBSubCircumcised_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBSubCircumcised.CheckedChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub CBSubPierced_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBSubPierced.CheckedChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub Button14_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNSaveDomSet.Click
	...
	Private Sub Button12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNLoadDomSet.Click
	...
	Private Sub BTNLocalTagPrevious_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNLocalTagPrevious.Click
	...
	Private Sub BTNLocalTagSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNLocalTagSave.Click
	...
	Private Sub TBLocalTagDir_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TBLocalTagDir.KeyPress
	...
	Private Sub CBRangeOrgasm_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBRangeOrgasm.CheckedChanged
		If CBRangeOrgasm.Checked = False Then
			NBAllowOften.Enabled = True
			NBAllowSometimes.Enabled = True
			NBAllowRarely.Enabled = True
	...
	Private Sub CBRangeRuin_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBRangeRuin.CheckedChanged
		If CBRangeRuin.Checked = False Then
			NBRuinOften.Enabled = True
			NBRuinSometimes.Enabled = True
			NBRuinRarely.Enabled = True
	...
	Private Sub CBRangeOrgasm_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBRangeOrgasm.LostFocus
		My.Settings.RangeOrgasm = CBRangeOrgasm.Checked
	End Sub
	Private Sub CBRangeRuin_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBRangeRuin.LostFocus
		My.Settings.RangeRuin = CBRangeRuin.Checked
	End Sub

	Private Sub NBAllowOften_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBAllowOften.LostFocus
		My.Settings.AllowOften = NBAllowOften.Value
	End Sub

	Private Sub NBAllowSometimes_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBAllowSometimes.LostFocus
		My.Settings.AllowSometimes = NBAllowSometimes.Value
	End Sub

	Private Sub NBAllowRarely_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBAllowRarely.LostFocus
		My.Settings.AllowRarely = NBAllowRarely.Value
	End Sub

	Private Sub NBRuinOften_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBRuinOften.LostFocus
		My.Settings.RuinOften = NBRuinOften.Value
	End Sub

	Private Sub NBRuinSometimes_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBRuinSometimes.LostFocus
		My.Settings.RuinSometimes = NBRuinSometimes.Value
	End Sub

	Private Sub NBRuinRarely_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBRuinRarely.LostFocus
		My.Settings.RuinRarely = NBRuinRarely.Value
	End Sub

	Private Sub TBSafeword_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBSafeword.LostFocus
		My.Settings.Safeword = TBSafeword.Text
	End Sub



	Private Sub Button4_Click_5(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
	...
	Private Sub subAgeNumBox_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles subAgeNumBox.MouseEnter
		TTDir.SetToolTip(subAgeNumBox, "Set your age.")
		'LBLSubSettingsDescription.Text = "Set your age."
	End Sub

	Private Sub NBBirthdayMonth_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBBirthdayMonth.MouseEnter
		TTDir.SetToolTip(NBBirthdayMonth, "Set the month you were born.")
		'LBLSubSettingsDescription.Text = "Set the month you were born."
	End Sub

	Private Sub Birthday_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles LBLSubBirthday.MouseHover
	...
	Private Sub NBBirthdayDay_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBBirthdayDay.MouseEnter
		TTDir.SetToolTip(NBBirthdayDay, "Set the day you were born.")
		'LBLSubSettingsDescription.Text = "Set the day you were born."
	End Sub

	Private Sub TBSubHairColor_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBSubHairColor.MouseHover
	...
	Private Sub TBSubEyeColor_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBSubEyeColor.MouseHover
	...
	Private Sub CockSizeNumBox_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CockSizeNumBox.MouseEnter
		TTDir.SetToolTip(CockSizeNumBox, "Set your cock size in inches.")
		'LBLSubSettingsDescription.Text = "Set your cock size in inches."
	End Sub

	Private Sub CBSubCircumcised_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBSubCircumcised.MouseHover
	...
	Private Sub CBSubPierced_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBSubPierced.MouseHover
	...
	Private Sub CBCBTCock_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCBTCock.MouseHover
	...
	Private Sub CBCBTBall_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCBTBalls.MouseHover
	...
	Private Sub CBTSlider_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTSlider.MouseHover
	...
	Private Sub GBPerformance_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs)
		LBLSubSettingsDescription.Text = "This area keeps track of several statistics related to your time with the program."
	End Sub

	Private Sub CBOwnChastity_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBOwnChastity.MouseHover
	...
	Private Sub CBChastityPA_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBChastityPA.MouseHover
	...
	Private Sub CBChastitySpikes_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBChastitySpikes.MouseHover
	...
	Private Sub TBGreeting_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBGreeting.MouseHover
	...
	Private Sub TBYes_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBYes.MouseHover
	...
	Private Sub TBNo_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBNo.MouseHover
	...
	Private Sub TBHonorific_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBHonorific.MouseHover
	...
	Private Sub G1Honorific_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles G1Honorific.MouseHover
	...
	Private Sub G2Honorific_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles G2Honorific.MouseHover
	...
	Private Sub G3Honorific_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles G3Honorific.MouseHover
	...
	Private Sub RandomHonorific_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles RandomHonorific.MouseHover
	...
	Private Sub CBHonorificInclude_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBHonorificInclude.MouseHover
	...
	End Sub
	Private Sub CBHonorificCapitalized_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBHonorificCapitalized.MouseHover
	...
	Private Sub NBLongEdge_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBLongEdge.MouseEnter
	...
	Private Sub CBEdgeUseAvg_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBEdgeUseAvg.LostFocus
		My.Settings.CBEdgeUseAvg = CBEdgeUseAvg.Checked
	End Sub
	Private Sub CBEdgeUseAvg_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBEdgeUseAvg.MouseEnter
	...
	Private Sub CBLongEdgeTaunts_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBLongEdgeTaunts.LostFocus
		My.Settings.CBLongEdgeTaunts = CBLongEdgeTaunts.Checked
	End Sub

	Private Sub CBLongEdgeTaunts_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBLongEdgeTaunts.MouseEnter
	...
	Private Sub CBLongEdgeInterrupts_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBLongEdgeInterrupts.LostFocus
		My.Settings.CBLongEdgeInterrupts = CBLongEdgeInterrupts.Checked
	End Sub

	Private Sub CBLongEdgeInterrupts_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBLongEdgeInterrupts.MouseEnter
	...
	Private Sub NBHOldTheEdgeMax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBHoldTheEdgeMax.MouseEnter
	...
	Private Sub NBWritinGTaskMin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBWritingTaskMin.MouseEnter
		LBLSubSettingsDescription.Text = "Sets the minimum amount of lines the domme will assign you for writing tasks."
	End Sub
	Private Sub NBWritinGTaskMax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBWritingTaskMax.MouseEnter
	...
	'End Sub
	Private Sub CBHimHer_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBHimHer.MouseEnter
	...
	Private Sub NBNextImageChance_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBNextImageChance.LostFocus
		My.Settings.NextImageChance = NBNextImageChance.Value
	End Sub



	Private Sub orgasmsperlockButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles orgasmsperlockButton.Click
	...
	Private Sub orgasmlockrandombutton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles orgasmlockrandombutton.Click
	...
	Private Sub CBVTType_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBVTType.SelectedIndexChanged
	...
	Private Sub NBTeaseLengthMin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTeaseLengthMin.MouseEnter
	...
	Private Sub NBTeaseLengthMax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTeaseLengthMax.MouseEnter
	...
	Private Sub CBTeaseLengthDD_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTeaseLengthDD.LostFocus
		My.Settings.CBTeaseLengthDD = CBTeaseLengthDD.Checked
	End Sub

	Private Sub CBTauntCycleDD_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTauntCycleDD.LostFocus
		My.Settings.CBTauntCycleDD = CBTauntCycleDD.Checked
	End Sub

	Private Sub CBTeaseLengthDD_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTeaseLengthDD.MouseEnter
	...
	Private Sub NBTauntCycleMin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTauntCycleMin.MouseEnter
		LBLRangeSettingsDescription.Text = "Set the minimum amount of time the domme will make you stroke during Taunt cycles."
	End Sub

	Private Sub NBTauntCycleMax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTauntCycleMax.MouseEnter
		LBLRangeSettingsDescription.Text = "Set the maximum amount of time the domme will make you stroke during Taunt cycles"
	End Sub

	Private Sub CBTauntCycleDD_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBTauntCycleDD.MouseEnter
	...
	Private Sub CBRangeOrgasm_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBRangeOrgasm.MouseEnter
	...
	Private Sub NBAllowOften_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBAllowOften.MouseEnter
	...
	Private Sub NBAllowSometimes_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBAllowSometimes.MouseEnter
	...
	Private Sub NBAllowRarely_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBAllowRarely.MouseEnter
	...
	Private Sub CBRangeRuin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBRangeRuin.MouseEnter
	...
	Private Sub NBRuinSometimes_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBRuinSometimes.MouseEnter
	...
	Private Sub NBRuinRarely_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBRuinRarely.MouseEnter
	...
	Private Sub NBNextImageChance_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBNextImageChance.MouseEnter
	...
	Private Sub nbcensorshowmax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBCensorShowMax.MouseEnter
	...
	Private Sub nbcensorhidemin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBCensorHideMin.MouseEnter
	...
	Private Sub nbcensorhidemax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBCensorHideMax.MouseEnter
	...
	Private Sub cbcensorconstant_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCensorConstant.MouseEnter
	...
	Private Sub nbredlightmin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBRedLightMin.MouseEnter
	...
	Private Sub nbredlightmax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBRedLightMax.MouseEnter
	...
	Private Sub nbgreenlightmin_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBGreenLightMin.MouseEnter
	...
	Private Sub nbgreenlightmax_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBGreenLightMax.MouseEnter
	...
	Private Sub RangeSet_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles Panel6.MouseEnter, GroupBox21.MouseEnter, GroupBox18.MouseEnter, GroupBox19.MouseEnter, GroupBox10.MouseEnter, GBRangeRuinChance.MouseEnter, GBRangeOrgasmChance.MouseEnter, GroupBox57.MouseEnter
		LBLRangeSettingsDescription.Text = "Hover over any setting in the menu for a more detailed description of its function."
	End Sub



	Private Sub TextBox2_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBWishlistURL.TextChanged
		Try
	...
	Private Sub radioGold_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles radioGold.CheckedChanged
		WishlistCostGold.Visible = True
		WishlistCostSilver.Visible = False
	End Sub

	Private Sub radioSilver_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles radioSilver.CheckedChanged
		WishlistCostGold.Visible = False
		WishlistCostSilver.Visible = True
	End Sub

	Private Sub TBWishlistItem_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBWishlistItem.TextChanged
	...
	Private Sub TBWishlistComment_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TBWishlistComment.TextChanged
		LBLWishListText.Text = TBWishlistComment.Text
	End Sub

	Private Sub BTNWishlistCreate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNWishlistCreate.Click
	...
	Private Sub CBOwnChastity_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBOwnChastity.CheckedChanged
	...
	Private Sub CBOwnChastity_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBOwnChastity.LostFocus
		My.Settings.CBOwnChastity = CBOwnChastity.Checked
	End Sub

	Private Sub CBChastityPA_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBChastityPA.LostFocus
		My.Settings.ChastityPA = CBChastityPA.Checked
	End Sub

	Private Sub CBChastitySpikes_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBChastitySpikes.LostFocus
		My.Settings.ChastitySpikes = CBChastitySpikes.Checked
	End Sub

	Private Sub CBHimHer_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBHimHer.LostFocus
		My.Settings.CBHimHer = CBHimHer.Checked
	End Sub

	Private Sub CBDomDel_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBDomDel.LostFocus
		My.Settings.DomDeleteMedia = CBDomDel.Checked
	End Sub

	Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNMaintenanceCancel.Click
		If BWURLFiles.IsBusy Then BWURLFiles.CancelAsync()
	End Sub
	...
	Private Sub TBWebStart_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBWebStart.LostFocus
		My.Settings.WebToyStart = TBWebStart.Text
	End Sub

	Private Sub TBWebStop_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBWebStop.LostFocus
	...
	Private Sub CBCockToClit_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCockToClit.LostFocus
		My.Settings.CockToClit = CBCockToClit.Checked
	End Sub

	Private Sub CBBallsToPussy_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBBallsToPussy.LostFocus
		My.Settings.BallsToPussy = CBBallsToPussy.Checked
	End Sub

	Private Sub CBCockToClit_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBCockToClit.MouseEnter
	...
	Private Sub CBBallsToPussy_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBBallsToPussy.MouseEnter
	...
	Private Sub LBPlaylist_DragEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles LBPlaylist.DragEnter
		If e.Data.GetDataPresent(DataFormats.FileDrop) Then
			e.Effect = DragDropEffects.Copy
		End If
	End Sub
	...
	Private Sub BTNPlaylistEnd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNPlaylistEnd.Click
	...
	Private Sub RadioPlaylistScripts_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioPlaylistScripts.CheckedChanged, RadioPlaylistRegScripts.CheckedChanged
	...
	Private Sub BTNPlaylistSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNPlaylistSave.Click
	...
	Private Sub BTNPlaylistClearAll_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNPlaylistClearAll.Click
	...
	Private Sub BTNPlaylistCtrlZ_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNPlaylistCtrlZ.Click
	...
	Private Sub RBGerman_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RBGerman.CheckedChanged, RBEnglish.CheckedChanged
		If FrmSettingsLoading = False Then
	...
	Private Sub ThemeLbl_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LBLBackColor2.Click, LBLButtonColor2.Click, LBLTextColor2.Click, LBLDateTimeColor2.Click, LBLDateBackColor2.Click, LBLChatWindowColor2.Click, LBLChatTextColor2.Click
		If GetColor.ShowDialog() = DialogResult.OK Then
			Form1.SuspendLayout()
	...
	Private Sub CBStretchBack_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBStretchBack.CheckedChanged
	...
	Private Sub CBTransparentTime_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBTransparentTime.CheckedChanged
	...
	Private Sub CheckBox1_CheckedChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBFlipBack.CheckedChanged
	...
	Private Sub NBTypoChance_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTypoChance.LostFocus
		My.Settings.TypoChance = NBTypoChance.Value
	End Sub

	Private Sub BTNWICreateURL_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWICreateURL.MouseHover
	...
	Private Sub CBWIreview_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBWIReview.MouseHover
	...
	Private Sub CBWISavetoDisk_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBWISaveToDisk.MouseHover
	...
	Private Sub BTNWIAddandContinue_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIAddandContinue.MouseHover
	...
	Private Sub BTNWIContinue_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIContinue.MouseHover
	...
	Private Sub BTNWICancel_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWICancel.MouseHover
		TTDir.SetToolTip(BTNWICancel, "Use this button to cancel URL File creation.")
	End Sub

	Private Sub BTNWIOpenURL_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIOpenURL.MouseHover
		TTDir.SetToolTip(BTNWIOpenURL, "Use this button to view a URL File you have previously created.")
	End Sub

	Private Sub BTNWIPrevious_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIPrevious.MouseHover
		TTDir.SetToolTip(BTNWIPrevious, "Use this button to view the previous image of a URL File.")
	End Sub

	Private Sub BTNWINext_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWINext.MouseHover
		TTDir.SetToolTip(BTNWINext, "Use this button to view the next image of a URL File.")
	End Sub

	Private Sub BTNWIRemove_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIRemove.MouseHover
		TTDir.SetToolTip(BTNWIRemove, "Use this button to remove an image from a URL File.")
	End Sub

	Private Sub BTNWILiked_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWILiked.MouseHover
		TTDir.SetToolTip(BTNWILiked, "Use this button to add the current image to your Liked URL Files list.")
	End Sub

	Private Sub BTNWIDisliked_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIDisliked.MouseHover
		TTDir.SetToolTip(BTNWIDisliked, "Use this button to add the current image to your Disliked URL Files list.")
	End Sub

	Private Sub BTNWISave_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWISave.MouseHover
		TTDir.SetToolTip(BTNWISave, "Use this button to save the current image to your hard drive.")
	End Sub

	Private Sub TBWIDirectory_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TBWIDirectory.MouseHover
		TTDir.SetToolTip(TBWIDirectory, "This is where images will be saved if ""Save Images to Disk"" is checked.")
	End Sub

	Private Sub BTNWIBrowse_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles BTNWIBrowse.MouseHover
		TTDir.SetToolTip(BTNWIBrowse, "Select the directory where images will be saved to disk.")
	End Sub

	Private Sub SliderVVolume_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles SliderVVolume.LostFocus
		My.Settings.VVolume = SliderVVolume.Value
	End Sub
	Private Sub SliderVRate_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles SliderVRate.LostFocus
		My.Settings.VRate = SliderVRate.Value
	End Sub

	Private Sub SliderVVolume_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles SliderVVolume.MouseHover
		TTDir.SetToolTip(SliderVVolume, "Adusts the volume of the domme's TTS voice.")
	End Sub

	Private Sub SliderVRate_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles SliderVRate.MouseHover
		TTDir.SetToolTip(SliderVRate, "Adusts the speed of the domme's TTS voice.")
	End Sub

	Private Sub SliderVVolume_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SliderVVolume.Scroll
		Form1.synth.Volume = SliderVVolume.Value
		Form1.synth2.Volume = SliderVVolume.Value
		LBLVVolume.Text = SliderVVolume.Value
	End Sub
	Private Sub SliderVRate_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SliderVRate.Scroll
		Form1.synth.Rate = SliderVRate.Value
		Form1.synth2.Rate = SliderVRate.Value
		LBLVRate.Text = SliderVRate.Value
	End Sub

	Private Sub sadisticCheckBox_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles sadisticCheckBox.LostFocus
		My.Settings.DomSadistic = sadisticCheckBox.Checked
	End Sub

	Private Sub degradingCheckBox_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles degradingCheckBox.LostFocus
		My.Settings.DomDegrading = degradingCheckBox.Checked
	End Sub
	...
	Private Sub BTNDebugTauntsClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNDebugTauntsClear.Click
		TBDebugTaunts1.Text = ""
		TBDebugTaunts2.Text = ""
		TBDebugTaunts3.Text = ""
	End Sub
	...
	Private Sub CBMuteMedia_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBMuteMedia.LostFocus
		My.Settings.MuteMedia = CBMuteMedia.Checked
	End Sub


	Private Sub BTNOfflineMode_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNOfflineMode.Click
	...
	Private Sub CBNewSlideshow_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBNewSlideshow.LostFocus
	...
	Private Sub NBTauntEdging_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles NBTauntEdging.LostFocus
		My.Settings.TauntEdging = NBTauntEdging.Value
	End Sub

	Private Sub BTNDebugTeaseTimer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNDebugTeaseTimer.Click
		Form1.ssh.TeaseTick = 5
	End Sub

	Private Sub BTNDebugStrokeTime_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNDebugStrokeTime.Click
		Form1.ssh.StrokeTick = 5
	End Sub

	Private Sub BTNDebugStrokeTauntTimer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNDebugStrokeTauntTimer.Click
		Form1.ssh.StrokeTauntTick = 5
	End Sub

	Private Sub BTNDebugEdgeTauntTimer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNDebugEdgeTauntTimer.Click
		Form1.ssh.EdgeTauntInt = 5
	End Sub

	Private Sub BTNDebugHoldEdgeTimer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNDebugHoldEdgeTimer.Click
	...
	Private Sub CBURLPreview_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles CBURLPreview.LostFocus
		My.Settings.CBURLPreview = CBURLPreview.Checked
	End Sub


	Private Sub NBTaskStrokesMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskStrokesMin.ValueChanged
		If NBTaskStrokesMin.Value > NBTaskStrokesMax.Value Then NBTaskStrokesMin.Value = NBTaskStrokesMax.Value
	End Sub
	Private Sub NBTaskStrokesMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskStrokesMax.ValueChanged
		If NBTaskStrokesMax.Value < NBTaskStrokesMin.Value Then NBTaskStrokesMax.Value = NBTaskStrokesMin.Value
	End Sub

	Private Sub NBTaskStrokingTimeMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskStrokingTimeMin.ValueChanged
		If NBTaskStrokingTimeMin.Value > NBTaskStrokingTimeMax.Value Then NBTaskStrokingTimeMin.Value = NBTaskStrokingTimeMax.Value
	End Sub
	Private Sub NBTaskStrokingTimeMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskStrokingTimeMax.ValueChanged
		If NBTaskStrokingTimeMax.Value < NBTaskStrokingTimeMin.Value Then NBTaskStrokingTimeMax.Value = NBTaskStrokingTimeMin.Value
	End Sub

	Private Sub NBTaskEdgesMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskEdgesMin.ValueChanged
		If NBTaskEdgesMin.Value > NBTaskEdgesMax.Value Then NBTaskEdgesMin.Value = NBTaskEdgesMax.Value
	End Sub
	Private Sub NBTaskEdgesMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskEdgesMax.ValueChanged
		If NBTaskEdgesMax.Value < NBTaskEdgesMin.Value Then NBTaskEdgesMax.Value = NBTaskEdgesMin.Value
	End Sub

	Private Sub NBTaskEdgeHoldTimeMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskEdgeHoldTimeMin.ValueChanged
		If NBTaskEdgeHoldTimeMin.Value > NBTaskEdgeHoldTimeMax.Value Then NBTaskEdgeHoldTimeMin.Value = NBTaskEdgeHoldTimeMax.Value
	End Sub
	Private Sub NBTaskEdgeHoldTimeMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskEdgeHoldTimeMax.ValueChanged
		If NBTaskEdgeHoldTimeMax.Value < NBTaskEdgeHoldTimeMin.Value Then NBTaskEdgeHoldTimeMax.Value = NBTaskEdgeHoldTimeMin.Value
	End Sub

	Private Sub NBTaskCBTTimeMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskCBTTimeMin.ValueChanged
		If NBTaskCBTTimeMin.Value > NBTaskCBTTimeMax.Value Then NBTaskCBTTimeMin.Value = NBTaskCBTTimeMax.Value
	End Sub
	Private Sub NBTaskCBTTimeMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTaskCBTTimeMax.ValueChanged
		If NBTaskCBTTimeMax.Value < NBTaskCBTTimeMin.Value Then NBTaskCBTTimeMax.Value = NBTaskCBTTimeMin.Value
	End Sub

	Private Sub NBTasksMin_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTasksMin.ValueChanged
		If NBTasksMin.Value > NBTasksMax.Value Then NBTasksMin.Value = NBTasksMax.Value
	End Sub
	Private Sub NBTasksMax_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles NBTasksMax.ValueChanged
		If NBTasksMax.Value < NBTasksMin.Value Then NBTasksMax.Value = NBTasksMin.Value
	End Sub

	Private Sub TypeSpeedSlider_MouseHover(ByVal sender As Object, ByVal e As System.EventArgs) Handles TypeSpeedSlider.MouseHover
	...
	Private Sub TypeSpeedSlider_Scroll(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TypeSpeedSlider.Scroll
		TypesSpeedVal.Text = TypeSpeedSlider.Value
	End Sub

	Private Sub TimedWriting_CheckedChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TimedWriting.MouseHover
	...
	Private Sub alwaysNewSlideshow_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles alwaysNewSlideshow.CheckedChanged
