...
ShowedBlogImage:
	...
	Private Sub updateMode(StringClean As String, ByVal modeToUpdate As Dictionary(Of String, Mode))
	...
	Private Function goingTo(commandToCheck As String) As String
